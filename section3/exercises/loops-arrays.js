...
var foods = ["butter", "salsa", "pizza", "tofu", "broccoli", "cheese"];
...
for (var i = 0; i < names.length; i++) {
  if (names[i] == "Sevy") { // You can only skip over one element in an array at a time!!!
    continue;
  }
  else if (names[i] == "Lindsey") {
    continue;
  }
